...
//    Return those unique elements as a new List.
    ...
    // Create a method that take a List of String as parameter. This method should:
    //Find the elements that appears more than once.
    // Return these repeated elements as a new List.
