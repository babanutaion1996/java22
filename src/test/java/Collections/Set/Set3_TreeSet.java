...
public class Set3_TreeSet {
    public static void main(String[] args) {
        ...
        System.out.println(numbers);// [0, 1, 2, 4, 5, 11] it sorts the elements is ascending order.
        // numbers.add(null); // Doesn't allow null value to be stored.
        ...
        // To get last element from the TreeSet
