package Arrays1._2D_Arrays;

public class _2D_Arrays_Intro {
    // Storing arrays, inside of an array.
    // A 2-dimensional array is like a table of data, organized into rows and columns, You can think of it as an arrays, where each element in the main array
    // is itself an arrays.
